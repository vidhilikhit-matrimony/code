    ...
    return (
        <div className={`flex items-start gap-4 p-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-xl transition-colors ${className}`}>
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center">
                ...
                <p className="text-sm text-slate-900 dark:text-slate-100 font-semibold whitespace-pre-wrap">{value}</p>
            </div>
        </div>
    );
};
                        ...
                        <div className="hidden md:flex flex-col items-end">
                            {user?.remainingViews > 0 ? (
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 rounded-lg text-sm border border-indigo-600 text-indigo-600 font-semibold hover:bg-indigo-50 transition-colors"
                                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-8 space-y-6">
                        ...
                        <Section title="Community Details" icon={Star} iconColor="text-amber-500">
                            ...
                            {profile.gana && <DetailRow icon={Star} label="Gana" value={profile.gana} iconColor="text-amber-500" />}
                            {profile.charana && <DetailRow icon={Star} label="Charana" value={profile.charana} iconColor="text-amber-500" />}
